...
export const DappLatestOrders = (props) => {
  const { orders = [], sx, latestEmails = [], dappName } = props;

  const emails = useMemo(() => latestEmails.slice(0, 50), [latestEmails]);
